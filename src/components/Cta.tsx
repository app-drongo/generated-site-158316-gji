...
// Generated: 2025-08-19T16:49:00.093Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "99.9%", label: "Client Retention", icon: Shield },
    { value: "200+", label: "Industry Experts", icon: Zap },
    { value: "24/7", label: "Dedicated Support", icon: Sparkles }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Discover how our comprehensive consulting services can transform your organization and drive sustainable growth. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Explore our services with a complimentary consultation
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Trusted by leading organizations with enterprise-grade security
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Customized consulting services to meet your unique business needs
              </p>
            </div>
          </div>
        </div>
